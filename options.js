...
module.exports = class Options {
  constructor() {
    ...
    this._gridColour = lightColour; // Powdered Sugar
  ...
  get bg() {
    if (this.isBackgroundUserColour) return this.backgroundColour;
  ...
  get isBackgroundUserColour() {
    return this._isBackgroundUserColour;
  }
